...
class DisplaySettingDialog(QDialog):
  ...
  def confirm(self):
    try:
      ...
      if bar_width != self.setting_json[WINRATE_BAR_WIDTH_KEY]:
        self.update_setting_json(WINRATE_BAR_WIDTH_KEY, bar_width)
      if bar_height != self.setting_json[WINRATE_BAR_HEIGHT_KEY]:
        self.update_setting_json(WINRATE_BAR_HEIGHT_KEY, bar_height)
